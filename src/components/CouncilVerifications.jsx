...
export default function CouncilVerifications() {
      ...
      <aside className={`sidebar ${mobileMenuOpen ? 'open' : ''}`}>
        ...
        <nav className="nav-menu">
          <div className="menu-items">
            <Link to="/council" className="nav-item">
              <FaHome /> Dashboard
            </Link>
            <Link to="/council/verifications" className="nav-item last-item active">
            ...
            {forwardedVerifications.length === 0 ? (
              ...
              <>
                <div style={{ marginBottom: '1rem', fontSize: '0.9rem', color: '#666' }}>
                  Showing {forwardedVerifications.length} verification request{forwardedVerifications.length !== 1 ? 's' : ''}
                </div>
